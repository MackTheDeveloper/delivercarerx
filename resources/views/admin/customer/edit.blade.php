                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="" action="{{route('update-customer')}}" method="post" enctype="multipart/form-data" id="customer-add">
                                        @csrf
...
@section('extrajs')
    ...
    <script src="{{ asset('app-assets/js/scripts/forms/validation/customer/customer-edit.js') }}"></script>
