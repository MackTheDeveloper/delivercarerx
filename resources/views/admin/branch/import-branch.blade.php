                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Import Branches</h4>
                                </div>
                                <div class="card-body">
                                    <form action="{{route('import-branches-data')}}" method="POST"
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            <a style="float: left"
                                               href="{{ asset('assets/samples/ImportBranch.xlsx') }}"
...
@section('extrajs')
    ...
    <!-- END: Page Vendor JS-->
    <script src="{{ asset('app-assets/js/scripts/forms/validation/import/import-branches.js') }}"></script>
