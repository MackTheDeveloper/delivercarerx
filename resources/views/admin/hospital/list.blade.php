          ...
          <div class="d-flex justify-content-between">
            <div class="breadcrumb-wrapper d-none d-sm-block ">
              <ol class="breadcrumb p-0 mb-0 pl-1">
                ...
                <li class="breadcrumb-item active"> Hospital
                </li>
              </ol>
            </div>

            <a id="addRow" href="{{route('admin.hospital-add')}}" class="btn btn-primary d-flex align-items-center">
...
<script src="{{ asset('app-assets/js/scripts/forms/validation/hospital/hospital-list.js') }}"></script>
@endsection