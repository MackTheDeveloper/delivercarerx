              ...
              <div class="card-body p-0">
                <div class="bs-stepper wizard-icons wizard-icons-example">
                  <div class="bs-stepper-header m-auto border-0">
                    <div class="step cross" data-target="#checkout-cart">
                      <a href="{{route('my-shopping-cart')}}" class="step-trigger"">
                        ...
                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M21.3125 48.313C22.9694 48.313 24.3125 46.9698 24.3125 45.313C24.3125 43.6561 22.9694 42.313 21.3125 42.313C19.6556 42.313 18.3125 43.6561 18.3125 45.313C18.3125 46.9698 19.6556 48.313 21.3125 48.313Z" stroke="#8494A7" stroke-width="2" stroke-miterlimit="10" stroke-linecap="square" />
                    ...
                    <div class="step cross" data-target="#checkout-address">
                      <a href="{{route('shipping-address')}}" class="step-trigger">
                        <span class="bs-stepper-icon">
                          <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="step cross active" data-target="#checkout-payment">
                ...
                <div class="cart-wrapper-pad">
                  <h6 class="mb-2 text-bold-600">My Shopping Bag ({{count($cartData)}} Items)</h6>

                  <div class="table-responsive">
                    <table class="table nowrap border-1px" id="Tdatatable">
                      <thead>
                        <tr>
                          <th>Rx No.</th>
                          <th>Drug</th>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Address Line 1" value="{{ $addressData->address_1 ?? "$addressData->address_1" }}" readonly name="address_1">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Address Line 2" value="{{ $addressData->address_2 ?? "$addressData->address_2" }}" readonly name="address_2">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          <div class="controls">
                            <label>State</label>
                            <!--<input type="text" class="form-control" placeholder="State" value="{{ $addressData->city_code ?? "$addressData->state" }}" readonly name="state_code">-->
                            <input type="text" class="form-control" placeholder="State" value="{{ $patientData->state ?? "$addressData->state" }}" readonly name="state_code">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="controls">
                            <label>City</label>
                            <input type="text" class="form-control" placeholder="City" value="{{ $addressData->city_code ?? "$addressData->city" }}" readonly name="city_code">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Zip Code" value="{{ $addressData->zipcode ?? "$addressData->zipcode" }}" readonly name="zipcode">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            ?><select class="select2 form-control" name="shipping_method" disabled>
                               <option value="FD2" @if($method == "FD2")
                            selected @endif>Second Day</option>
                               <option value="FD1" @if($method == "FD1")
                            selected @endif>Next Day</option>
                               <option value="RSD" @if($method == "RSD")
                            selected @endif>SameDay (Az Only)</option>
                               <option value="FDS" @if($method == "FDS")
                            selected @endif>Saturday</option>
                               <option value="ES2" @if($method == "ES2")
                            selected @endif>STAT 2 (Az Only)</option>
                               <option value="RST" @if($method == "RST")
                            selected @endif>STAT 4 (Az Only)</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <textarea readonly class="form-control" placeholder="Notes to Pharmacy" name="notes">{{ $addressData->notes }}</textarea>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                          <div class="controls">
                            <div class="checkbox checkbox-primary checkbox-glow">
                              <input disabled type="checkbox" id="checkboxGlow1" name="signature" @if($addressData->signature)
                            checked
                            @endif>
                  ...
                  <div class="d-flex mt-2 cart-btn-wrapper">
                    <a href="{{ route('refill-place-order') }}" class="btn btn-primary" id="placeOrderBtn">Place Order</a>
                    <a href="{{ route('shipping-address') }}" class="btn btn-light-secondary">Back</a>
                  </div>
