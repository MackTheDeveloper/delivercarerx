...
@section('title', 'Shipping Carrier Edit')
@section('extracss')
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                 <form method="post" action="{{ route('update-shipping') }}" id="shipping-add" enctype="multipart/form-data">
                  @csrf
                   <input type='hidden' name="id" value="{{ $model->id }}">
                  <div class="media">
                   <a href="javascript: void(0);">
                      <img src="{{ $model->logo ? $model->logo : asset('assets/img/shipping-logo') }}"
                    ...
                    <div class="media-body mt-25">
                      <div class="col-12 px-0 d-flex flex-sm-row flex-column justify-content-start">
                        <label for="select-files" class="btn btn-sm btn-light-primary ml-50 mb-50 mb-sm-0">
                          ...
                          <input id="select-files" type="file" value="{{$model->logo}}" name="logo" hidden>
                        </label>
                  ...
                  <div class="row">
                    ...
                    @endif">
                      <div class="form-group">
                        <div class="controls">
                          <input type="text" class="form-control" placeholder="Tracking URL Consists Of" value="{{$model->tracking_url}}" name="tracking_url" id="tracking_url">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    @endif">
                      <div class="form-group">
                        <div class="controls">
                          <input type="text" class="form-control" placeholder="Tracking Number Prefix" value="{{$model->tracking_prefix}}" name="tracking_prefix" id="tracking_prefix">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    @endif">
                      <div class="form-group">
                        <div class="controls">
                          <input type="text" class="form-control" placeholder="Tracking Number Length" value="{{$model->tracking_length}}" name="tracking_length" id="tracking_length">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    @endif">
                      <div class="form-group">
                        <div class="controls">
                          <input type="text" class="form-control" placeholder="Tracking Number Suffix" value="{{$model->tracking_suffix}}" name="tracking_suffix" id="tracking_suffix">
                        </div>
                      </div>
                    </div>
                  </div>
...
<!--  <script src="{{ asset('app-assets/js/scripts/forms/validation/shipping/shipping-edit.js') }}"></script>
 --><!-- END: Page Vendor JS-->
 <script>
