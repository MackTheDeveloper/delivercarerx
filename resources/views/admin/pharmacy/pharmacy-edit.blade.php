                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="" action="{{route('update-pharmacy')}}" method="post" enctype="multipart/form-data" id="pharmacy-add">
                                        @csrf
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="google link" name="google_link"
                                                            value="{{ $model->google_link }}" name="name">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=" NewLeaf Endpoint  "
                                                            value="{{ $model->newleaf_endpoint }}" name="newleaf_endpoint">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="  NewLeaf Port "
                                                            value="{{ $model->newleaf_port }}" name="newleaf_port">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label> NewLeaf Username </label>
                                                        <input type="text" class="form-control" placeholder=" NewLeaf Username "
                                                            value="{{ $model->newleaf_username }}" name="newleaf_username">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=" NewLeaf Password "
                                                            value="{{ $model->newleaf_password }}" name="newleaf_password">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=" Rover API User "
                                                            value="{{ $model->roverAPI_user }}" name="roverAPI_user">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=" Rover API Password "
                                                            value="{{ $model->roverAPI_password }}" name="roverAPI_password">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=" Rover API Account Number "
                                                            value="{{ $model->roverApi_accountnumber }}" name="roverApi_accountnumber">
                                                    </div>
                                                </div>
                                            </div>
...
@section('extrajs')
    ...
    <script src="{{ asset('app-assets/js/scripts/forms/validation/pharmacy/pharmacy-edit.js') }}"></script>
