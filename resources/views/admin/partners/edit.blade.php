          ...
          <div class="d-flex justify-content-between">
            <div class="breadcrumb-wrapper d-none d-sm-block ">
              <ol class="breadcrumb p-0 mb-0 pl-1">
                ...
                <li class="breadcrumb-item"><a href="@if(whoCanCheck(config('app.arrWhoCanCheck'), 'partner_listing') === true){{route('partners-list')}} @endif">Partners</a>
                </li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ route('updatePartners',encrypt($data->id)) }}" method="post" id="partner-edit">
                  @csrf
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="controls">
                        <label>City</label>
                        <input type="text" class="form-control" placeholder="City" value="{{$data->city}}" name="city">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="controls">
                        <label>State</label>
                        <input type="text" class="form-control" placeholder="State" value="{{$data->state}}" name="state">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <input type="text" class="form-control" placeholder="Username" value="{{$data->username}}" name="username">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          <div class="controls">
                              <label>Notes</label>
                              <textarea class="form-control" id="notes" name="notes" rows="4" cols="40">{{$data->notes}}</textarea>
                          </div>
                      </div>
                  </div>
...
<script src="{{asset('app-assets/js/scripts/forms/validation/partners/partner-edit.js')}}"></script>
<!-- END: Page Vendor JS-->
