        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ route('partners-store') }}" method="post" id="partner-add">
                  @csrf
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          <div class="controls">
                              <label>Notes</label>
                              <textarea class="form-control" id="notes" name="notes" rows="4" cols="40"></textarea>
                          </div>
                      </div>
                  </div>
...
<script src="{{asset('app-assets/js/scripts/forms/validation/partners/partner-add.js')}}"></script>
<!-- END: Page Vendor JS-->
