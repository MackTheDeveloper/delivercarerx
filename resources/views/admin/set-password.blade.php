                            ...
                            <div class="row m-0">
                                <div class="col-md-6 col-12 px-0">
                                    <div class="card disable-rounded-right d-flex justify-content-center mb-0 p-2">
                                        ...
                                        <div class="card-body">
                                            <form class="mb-2" id="reset-password" action="{{ route('set-password') }}" method="post">
                                                @csrf
                                                ...
                                                <button type="submit"
                                                    class="btn btn-primary glow position-relative w-100">Set Password<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
