...
@section('title', 'Hospice User Add')
@section('extracss')
        ...
        <div class="content-wrapper">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="breadcrumb-wrapper d-none d-sm-block ">
                                <ol class="breadcrumb p-0 mb-0 pl-1">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('hospice-user-list') }}">Hospice Users</a>
                                    </li>
                                    <li class="breadcrumb-item active">Add Hospice User
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <section id="basic-input">
                    <div class="row">
                        <div class="col-md-12">
                          <form method="post" action="{{route('hospice-store-user')}}" enctype="multipart/form-data" id="user-add">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Role</label>
                                                <select class="select2 form-control role" class="role" name="hospice_user_role">
                                        ...
                                        <div class="col-md-6 storeHide" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <select id="facility_id" name="facility_id" class="select2 form-control" required>
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 storeHide" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <select id="branch_id" name="branch_id[]" multiple="multiple" class="select2 form-control" required>
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('hospice-user-list') }}" type="reset" class="btn btn-light-secondary">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('extrajs')
    ...
    <!-- END: Page Vendor JS-->
    <script src="{{ asset('app-assets/js/scripts/forms/validation/hospice-user/user-add.js') }}"></script>
