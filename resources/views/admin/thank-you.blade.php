              ...
              <div class="card-body p-0">
                <div class="bs-stepper wizard-icons wizard-icons-example">
                  <div class="bs-stepper-header m-auto border-0">
                    ...
                    <div class="step cross" data-target="#checkout-payment">
                    ...
                    <div class="step cross active" data-target="#checkout-confirmation">
                      <a href="#" class="step-trigger" aria-selected="false">
                        <span class="bs-stepper-icon">
                          <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="cart-wrapper-pad">
                  <div class="thank-you-parent">
                    <img src="{{asset('assets/img/Sucess-badge.svg')}}" class="mb-1" />
                    <h5 class="text-bold-600">Thank You! </h5>
                    <p class="mb-0">Your refill order <span class="primary">{{$order_number}}</span> has been placed!</p>
                  </div>

                  <div class="d-flex mt-2 btn-center">
                    <a href="{{ route('nursePatients-list') }}" class="btn btn-primary">Go to Home</a>
                  </div>
