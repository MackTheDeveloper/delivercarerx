                        ...
                        <div class="d-flex justify-content-between">
                            <div class="breadcrumb-wrapper d-none d-sm-block ">
                                <ol class="breadcrumb p-0 mb-0 pl-1">
                                    ...
                                    <li class="breadcrumb-item active">Hospice</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                              <div class="card-header">
                                <h4 class="card-title">Import Hospice</h4>
                              </div>
                                <div class="card-body">
                                    <form action="{{ route('admin.uploadHospice') }}" enctype="multipart/form-data" method="post" class="dropzone dropzone-area " id="dpz-single-file">
                                    ...
                                    <div class="col-12 d-flex justify-content-end" style="margin-top: 20px;">
                                        <a style="float: left" href="{{ asset('assets/samples/ImportHospice.xlsx') }}"
...
@section('extrajs')
    ...
    <script src="{{ asset('app-assets/js/scripts/forms/validation/import/import-hospice.js') }}"></script>
