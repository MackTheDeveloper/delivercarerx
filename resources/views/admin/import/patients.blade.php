                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Import Patients</h4>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('import-patients-data') }}" method="post"
                                        class="dropzone dropzone-area" id="dpz-single-file" enctype="multipart/form-data">
                                        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                                        <div class="dz-message">Drop Files Here To Upload</div>
                                    </form>
                                    <div class="col-12 d-flex justify-content-end">
                                        <a style="float: left" href="{{ asset('assets/samples/patient_import.xlsx') }}"
                                            class="btn btn-primary mr-1">Download Sample</a>
                                            
                                        <button type="submit" class="submit-btn btn btn-primary mr-1">Import</button>
                                    ...
                                    <div class="alert alert-danger import-header-column-mismatch mt-1 d-none" role="alert">
...
@section('extrajs')
    ...
    <!-- END: Page Vendor JS-->
    <script src="{{ asset('app-assets/js/scripts/forms/validation/import/import-patient.js') }}"></script>
@endsection
