              ...
              <div class="card-body p-0">
                <div class="bs-stepper wizard-icons wizard-icons-example">
                  <div class="bs-stepper-header m-auto border-0">
                    <div class="step cross active" data-target="#checkout-cart">
                ...
                <input type="hidden" id="id" name="id" value={{$newLeafCustId ?? ''}} />
                <input type="hidden" name="result" id="result" value="<?php echo implode(',', $value); ?>">
                <input type="hidden" name="rNum" id="rNum" value="{{$rIds}}">
                ...
                <div class="cart-wrapper-pad">
                    ...
                    <h5>Patient Name: <span><b>{{$patientName}}</b></span></h5>
               
                  <h6 class="mb-2 text-bold-600">Cart ({{count($cartItems)}} <?php if(count($cartItems) == 1){?> Item <?php } else { ?> Items <?php } ?>)</h6>
                  ...
                  <div class="table-responsive">
                    <table class="table nowrap border-1px" id="Tdatatable">
                      ...
                      <tbody>
                        ...
                        <input type="hidden" id="var_value" name="var_value" value={{ $item['rxnumber'] }} />
                            <tr>
                                <td>{{ $item['rxnumber'] }}</td>
                  ...
                  <div class="d-flex mt-3 cart-btn-wrapper">
                    <a href="{{route('shipping-address')}}" class="btn btn-primary">Proceed</a>
                    <a href="{{route('patientsList', $newLeafCustId)}}" class="btn btn-primary">Add More</a>
                    <a class="btn btn-light-secondary delete-popup" href="javascript:void(0);">Empty Cart</a>
                  </div>
...
@include('components.delete-all-popup')
