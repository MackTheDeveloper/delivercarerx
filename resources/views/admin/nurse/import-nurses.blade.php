                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Import Nurses</h4>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('import-nurse-data') }}" enctype="multipart/form-data" method="post" class="dropzone dropzone-area " id="dpz-single-file">
                                    ...
                                    <div class="col-12 d-flex justify-content-end" style="margin-top: 20px;">
                                        <a style="float: left" href="{{ asset('assets/samples/nurse-sample.xlsx') }}"
                                                class="btn btn-primary mr-1">Download Sample</a>
                                        <button type="submit" class="btn btn-primary mr-1" id="buttonSubmit">Import</button>
                                    ...
                                    <div class="alert alert-danger import-email-error mb-0 mt-2 d-none" role="alert">
                                        Error! An issue with the email address has occurred. 
                                    </div>

                                    <!--<div class="alert alert-danger import-something-went-wrong mb-0 mt-2 d-none" role="alert">
                                    ...
                                    <div class="alert alert-danger import-header-email-already-exist mt-1 d-none" role="alert">
