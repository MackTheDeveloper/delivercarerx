          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none">
                ...
                <span class="user-status text-muted">DeliverCare Admin</span>
              </div>
              <span>
            ...
            <div class="dropdown-menu dropdown-menu-right pb-0">
              <a class="dropdown-item" href="{{route('htmlpages','profile')}}">
                <span class="user-name">{{auth()->user()->first_name. ' '. auth()->user()->last_name}}</span>
                <span class="user-status text-muted">{{auth()->user()->roles->role_title}}</span>
              </div>
              <span>
                <img class="round" src="{{asset('images/'.auth()->user()->profile_picture)}}" alt="avatar" height="40" width="40">
              </span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pb-0">
              ...
              <a class="dropdown-item" href="{{route('htmlpages','login')}}">
